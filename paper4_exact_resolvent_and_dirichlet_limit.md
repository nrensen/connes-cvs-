...
| Section 6.7 (Proposition 6.7, Cells 51–52) | Continuous Archimedean integral, discrete Cauchy transform & spectral crossover | `cell46.py`, `cell51.py`, `cell52.py` | `cell46.out`, `cell51.out`, `cell52.out` |
