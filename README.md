...
The accompanying paper is on **arXiv** - [arXiv:2605.20224](https://arxiv.org/abs/2605.20224) (math.NT) - and archived on **Zenodo**, where the concept DOI [10.5281/zenodo.19546514](https://doi.org/10.5281/zenodo.19546514) always resolves to the latest version. Three corrections are recorded in [ERRATA.md](https://github.com/akivag613/connes-cvs-/blob/main/ERRATA.md), none of which changes a quantitative result: the $c=100$ and $L(s,\chi_3)$ negative-sign eigenvalue claims are finite-cutoff artifacts (2026-06-26, in the published manuscript text); the Section 8.2 Paley-Wiener mechanism is withdrawn and Table 14 is measured at $T=400$ (2026-08-12); and the $c=67$ matching-digit count is 167 rather than 168 (2026-08-12). The two 2026-08-12 entries are carried by the errata file and are not yet folded into the manuscript text.
