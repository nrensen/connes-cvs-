...
The accompanying paper is on **arXiv** - [arXiv:2605.20224](https://arxiv.org/abs/2605.20224) (math.NT) - and archived on **Zenodo**, where the concept DOI [10.5281/zenodo.19546514](https://doi.org/10.5281/zenodo.19546514) always resolves to the latest version. Four corrections are recorded in [ERRATA.md](https://github.com/akivag613/connes-cvs-/blob/main/ERRATA.md), none of which changes a measured value: the $c=100$ and $L(s,\chi_3)$ negative-sign eigenvalue claims are finite-cutoff artifacts (2026-06-26, in the published manuscript text); the Section 8.2 Paley-Wiener mechanism is withdrawn and Table 14 is measured at $T=400$ (2026-08-12); the $c=67$ matching-digit count is 167 rather than 168 (2026-08-12); and two summary digit-increment ranges in Section 6.5 are 93-117 and 181-203 (2026-08-13). All four are now incorporated in the manuscript text deposited on Zenodo, and the same revision has been submitted to arXiv.
