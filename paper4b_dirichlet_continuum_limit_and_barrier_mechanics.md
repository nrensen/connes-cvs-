...
### Proposition 8.29 (Analytical Operator-Norm Reduction of Hypothesis $\mathrm{H}_{\mathrm{cont}}$)
...
1. **Loewner Divided-Difference Structure and Uniform Operator-Norm Bound:**
   The Galerkin matrix $Q_{c, N}$ is the Pick/Loewner divided-difference matrix generated by the generating function $\psi(x) = \psi_{\mathrm{prime}}(x) + \psi_{\mathrm{pole}}(x) + \psi_{\mathrm{arch}}(x)$:
   $$Q_{m, n} = \begin{cases} \dfrac{\psi(m) - \psi(n)}{m - n}, & m \ne n, \\ \psi'(n), & m = n. \end{cases}$$
   Because the prime sum is finite ($n \le c$), the pole integral is smooth, and the archimedean quadrature is supported on the compact interval $[-T, T]$, $\psi(x)$ is real-analytic with uniformly bounded derivative $\|\psi'\|_\infty \equiv \sup_{x \in \mathbb{R}} |\psi'(x)| < \infty$ and bounded variation.
   By Peller's theorem on divided-difference operators and the Schur test, $Q_{c, N}$ is the finite compression to $\operatorname{span}\{e_k\}_{k=-N}^N$ of a bounded self-adjoint operator $Q_c \in \mathcal{B}(\ell^2(\mathbb{Z}))$. Consequently, the operator norm is uniformly bounded independent of $N$:
   $$\boxed{\|Q_{\mathrm{even}}^{(N)}\| \le \|Q_{c, N}\| \le M(c, T) < \infty \qquad (\forall N \ge 1).}$$
...
3. **Analytical Reduction of Hypothesis $\mathrm{H}_{\mathrm{cont}}$:**
   ...
   Under this reduction, the continuum tail telescopes into the non-computational, explicit upper bound:
...
4. **The Structural Question of Barrier Index Invariance:**
   The validity of the Three-Regime Architecture in the continuum limit $N \to \infty$ depends on whether the effective barrier cutoff index $K$ remains fixed ($K(N) = \mathcal{O}(1)$) or drifts with dimension ($K(N) \to \infty$). If $K(N) \le K_* < \infty$, the tunneling core retains fixed finite cardinality and the continuum tail bound closes uniformly; if $K(N)$ drifts, the core cardinality scales with $N$ and mode-by-mode control must be supplemented by a collective tunneling estimate.

---

#### Table 8.25.19: Three-Regime Partition, Continuum Gap Enclosure $C_{\mathrm{cont}}(K)$, and Calibrated Tail Bounds (`cell85.out`, $j=2$)

| Truncation $N$ | Barrier Cutoff $K$ | Tunneling Sum $S_{\mathrm{tunnel}}$ | Continuum Dev $S_{\mathrm{cont}}$ | Continuum Envelope $C_{\mathrm{cont}}(N; K)$ | Peak Mode $\ell^*$ | Calibrated Bound $S_{\mathrm{cont}}^{\mathrm{calib}}$ | Slack Ratio | Continuum Share |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **$N = 8$** | $K=6$ | $1.651 \times 10^{-4}$ | $4.897 \times 10^{-10}$ | $1.950$ | $\ell^* = 7$ | $1.034 \times 10^{-9}$ | $2.112$ | $0.000267\%$ |
| **$N = 12$** | $K=6$ | $8.438 \times 10^{-5}$ | $4.662 \times 10^{-13}$ | $51.76$ | $\ell^* = 7$ | $5.481 \times 10^{-11}$ | $117.6$ | $5.21 \times 10^{-7}\%$ |
| **$N = 12$** | $K=10$ | $8.438 \times 10^{-5}$ | $1.215 \times 10^{-16}$ | $1.181$ | $\ell^* = 11$ | $3.176 \times 10^{-16}$ | $2.615$ | $1.36 \times 10^{-10}\%$ |
| **$N = 16$** | $K=6$ | $4.166 \times 10^{-5}$ | $1.270 \times 10^{-14}$ | $347.8$ | $\ell^* = 7$ | $1.127 \times 10^{-11}$ | $887.5$ | $2.79 \times 10^{-8}\%$ |
| **$N = 16$** | $K=10$ | $4.166 \times 10^{-5}$ | $1.217 \times 10^{-20}$ | $1.195$ | $\ell^* = 15$ | $2.947 \times 10^{-20}$ | $2.422$ | $2.67 \times 10^{-14}\%$ |
| **$N = 16$** | $K=11$ | $4.166 \times 10^{-5}$ | $1.012 \times 10^{-20}$ | $1.195$ | $\ell^* = 15$ | $2.291 \times 10^{-20}$ | $2.264$ | $2.22 \times 10^{-14}\%$ |
| **$N = 16$** | $K=12$ | $4.166 \times 10^{-5}$ | $4.583 \times 10^{-21}$ | $1.195$ | $\ell^* = 15$ | $1.437 \times 10^{-20}$ | $3.136$ | $1.01 \times 10^{-14}\%$ |
| **$N = 16$** | $K=14$ | $4.166 \times 10^{-5}$ | $3.893 \times 10^{-21}$ | $1.195$ | $\ell^* = 15$ | $8.489 \times 10^{-21}$ | $2.181$ | $8.55 \times 10^{-15}\%$ |
| **$N = 20$** | $K=6$ | $2.782 \times 10^{-5}$ | $4.209 \times 10^{-16}$ | $736.2$ | $\ell^* = 7$ | $7.595 \times 10^{-13}$ | $1805.0$ | $1.43 \times 10^{-9}\%$ |
| **$N = 20$** | $K=10$ | $2.782 \times 10^{-5}$ | $3.885 \times 10^{-24}$ | $1.635$ | $\ell^* = 11$ | $8.970 \times 10^{-24}$ | $2.309$ | $1.32 \times 10^{-17}\%$ |
| **$N = 20$** | $K=11$ | $2.782 \times 10^{-5}$ | $1.622 \times 10^{-24}$ | $1.193$ | $\ell^* = 13$ | $2.741 \times 10^{-24}$ | $1.690$ | $5.53 \times 10^{-18}\%$ |
| **$N = 20$** | $K=12$ | $2.782 \times 10^{-5}$ | $1.495 \times 10^{-24}$ | $1.193$ | $\ell^* = 13$ | $2.442 \times 10^{-24}$ | $1.633$ | $5.10 \times 10^{-18}\%$ |
| **$N = 20$** | $K=14$ | $2.782 \times 10^{-5}$ | $8.004 \times 10^{-25}$ | $1.123$ | $\ell^* = 18$ | $1.278 \times 10^{-24}$ | $1.597$ | $2.73 \times 10^{-18}\%$ |
| **$N = 24$** | $K=6$ | $1.351 \times 10^{-5}$ | $7.464 \times 10^{-17}$ | $816.5$ | $\ell^* = 7$ | $1.645 \times 10^{-13}$ | $2204.0$ | $5.32 \times 10^{-10}\%$ |
| **$N = 24$** | $K=10$ | $1.351 \times 10^{-5}$ | $2.459 \times 10^{-26}$ | $3.294$ | $\ell^* = 11$ | $1.020 \times 10^{-25}$ | $4.148$ | $1.75 \times 10^{-19}\%$ |
| **$N = 24$** | $K=11$ | $1.351 \times 10^{-5}$ | $3.667 \times 10^{-27}$ | $1.379$ | $\ell^* = 12$ | $9.508 \times 10^{-27}$ | $2.593$ | $2.61 \times 10^{-20}\%$ |
| **$N = 24$** | $K=12$ | $1.351 \times 10^{-5}$ | $1.709 \times 10^{-27}$ | $1.133$ | $\ell^* = 21$ | $4.547 \times 10^{-27}$ | $2.661$ | $1.22 \times 10^{-20}\%$ |
| **$N = 24$** | $K=14$ | $1.351 \times 10^{-5}$ | $1.579 \times 10^{-27}$ | $1.133$ | $\ell^* = 21$ | $3.486 \times 10^{-27}$ | $2.208$ | $1.13 \times 10^{-20}\%$ |

The empirical audit of Lemma 8.27, the gap representation, the Three-Regime Partition, and the calibrated continuum tail bound were established in Milestones M29–M31 (`cell83.py`–`cell85.py`). The investigation of analytical operator-norm bounds $\|Q_{c, N}\| \le M(c, T)$, the spectral gap ceiling $\Delta_{\max} \le M$, and barrier index invariance $K(N) = \mathcal{O}(1)$ is formulated in Milestone M32 (`cell86.py`).
