...
| **M-G1.6** | Gate 1 | **Unified Representation & Variational Formulation:** Coordinate-space mapping $T_{v_{\mathrm{bad}}}(t)$ and exact Euler–Lagrange constrained variational structure $(\mathcal{Q}_{\mathrm{comp}} - \mu_0 I) v_{\mathrm{bad}} = \sum \lambda_k u_k$; structural origin of macroscopic margin $R_{\mathrm{net}} \approx 0.165 > 0$; stable three-way partition $R_{\mathrm{mult}} - R_W + R_{\mathcal{D}}^{\mathrm{true}} = -0.487$; continuum variational problem $\mathcal{E}[T]$ | [`cell133.md`](file:///c:/data/github/connes-cvs-/cell133.md) / [`cell134.md`](file:///c:/data/github/connes-cvs-/cell134.md) / [`cell135.md`](file:///c:/data/github/connes-cvs-/cell135.md) | **IN PROGRESS (Cell 134 Certified; Cell 135 Authored)** |
