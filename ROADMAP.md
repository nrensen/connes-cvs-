...
| **M-G1.6** | Gate 1 | **Unified Representation of Coupled Cancellation:** Coordinate-space mapping $T_{v_{\mathrm{bad}}}(t)$ and structural origin of the macroscopic margin $R_{\mathrm{net}} \approx 0.165 > 0$; analytical proof that $R_{\mathrm{arch}} + R_{\mathrm{pole}} > |R_{\mathrm{comp}}|$ in the continuum limit | [`cell133.md`](file:///c:/data/github/connes-cvs-/cell133.md) | **PLANNED** |
