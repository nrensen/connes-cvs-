...
| **M-G1.5** | Gate 1 | **Variational Quasimode Codimension Bound:** Coordinate componentwise domination retired ($C_{\mathrm{arch}} - C_{\mathrm{prime}} < 0$); scalar functional subordination proved obstructed by scaling mismatch; unified Friedrichs form min-max on $\Phi^\perp$ ratified | [`cell125.md`](file:///c:/data/github/connes-cvs-/cell125.md) / [`cell126.md`](file:///c:/data/github/connes-cvs-/cell126.md) / [`cell127.md`](file:///c:/data/github/connes-cvs-/cell127.md) | **ACTIVE (Cell 127)** |
