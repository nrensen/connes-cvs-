...
| **M-G1.3** | Gate 1 | Route 1B Analysis: 2D $(N, L)$ Core-Size Invariant Product Mapping & Continuum Transition across $L \in \{4 \dots 16\}, N \in [16 \dots 64]$ | [`cell121.py`](file:///c:/data/github/connes-cvs-/cell121.py) / [`cell121.out`](file:///c:/data/github/connes-cvs-/cell121.out) | **IN PROGRESS (Cell 121)** |
