...
| **M-G1.6** | Gate 1 | **Unified Representation & Variational Formulation:** Coordinate-space mapping $T_{v_{\mathrm{bad}}}(t)$ and exact Euler–Lagrange constrained variational structure $(\mathcal{Q}_{\mathrm{comp}} - \mu_0 I) v_{\mathrm{bad}} = \sum \lambda_k u_k$; Bridge A closed to machine precision ($< 1.18 \times 10^{-49}$) via exact closed-form Fourier integral; continuum quadratic form $\mathcal{E}[T]$ on $H^{\log}([0, L])$ (KLMN self-adjoint generator $H_{\mathrm{comp}}$); projected step potential $W_{\perp \mathcal{B}} = P_{\mathcal{B}^\perp} \widetilde{W} P_{\mathcal{B}^\perp}$ and full 11-mode constant enclosure $\varepsilon_0(N)$ | [`cell133.md`](file:///c:/data/github/connes-cvs-/cell133.md) / [`cell134.md`](file:///c:/data/github/connes-cvs-/cell134.md) / [`cell135.md`](file:///c:/data/github/connes-cvs-/cell135.md) / [`cell136.md`](file:///c:/data/github/connes-cvs-/cell136.md) / [`cell137.md`](file:///c:/data/github/connes-cvs-/cell137.md) | **IN PROGRESS (Cells 133–136 Certified; Cell 137 Authored & Ready)** |
