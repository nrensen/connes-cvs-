...
| **M16** | Exact variational energy excess of coordinate wavepacket $Kc$, Rayleigh quotient gap enclosure, and asymptotic alignment sandwich | Paper 4B Proposition 8.21 | **COMPLETED** (Proved $\langle Kc, Q_{\mathrm{odd}} Kc \rangle = \lambda \|Kc\|^2 + D_0^2 M_1$ and $\langle Kc, (Q_{\mathrm{odd}} - \mu_0 I) Kc \rangle = D_0^2 M_1^{\mathrm{exc}} - (\mu_0 - \lambda) \|P_{\perp u_0} Kc\|^2$ from the rank-two commutator; proved two-sided sandwich $\frac{\mathcal{R}_1}{\|Kc\|^2} R_{\mathrm{gap}} \le \frac{\|P_{\perp u_0} Kc\|^2}{\|Kc\|^2} \le \frac{M_1^{\mathrm{exc}}}{\|Kc\|^2} R_{\mathrm{gap}}$; established analytical hierarchy reducing $R_{\mathrm{gap}} \to 0$ to asymptotic alignment $\frac{Kc}{\|Kc\|} \to \pm u_0$) |
