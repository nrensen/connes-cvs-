...
| **M-G1.5** | Gate 1 | **Variational Quasimode Codimension Bound:** First-principles derivation of variational lower bound on $\Phi^\perp$ resolving non-circularity for continuum threshold $E_{L+1}$ | [`cell124.md`](file:///c:/data/github/connes-cvs-/cell124.md) / [`cell125.md`](file:///c:/data/github/connes-cvs-/cell125.md) | **ACTIVE (Cell 125)** |
